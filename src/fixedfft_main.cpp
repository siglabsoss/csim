...
int sc_main(int argc, char* argv[])
{
    ...
    sc_signal<sc_int<32> > x_in_r, x_in_im, ready_in_2, ready_in_1, ready_out_1,
            ready_in_3;
    sc_signal<sc_int<32> > z_r_1, z_im_1, z_r_2, z_im_2, z_r, z_im,
            valid_Data_IN, valid_Data_OUT, valid_Data_OUT_1, valid_Data_OUT_2;
    ...
    m3.valid_Data_IN(valid_Data_OUT_1);
    m3.valid_Data_OUT(valid_Data_OUT_2);
