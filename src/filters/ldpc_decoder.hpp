...
#define LDPC_LLR_WL 8
#define LDPC_LLR_IWL 6
#define LDPC_LLR_FORMAT LDPC_LLR_WL, LDPC_LLR_IWL, SLFixPoint::QUANT_RND_HALF_UP, \
...
public:
    ...
    struct GraphEdgeKey
    {
        GraphEdgeKey(size_t checkNodeNum,
                     size_t bitNodeNum) :
