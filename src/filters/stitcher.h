...
public:
    ...
    vector<FixedComplex<32> > stitch(int numSamples, int sampleRate,
            int frequency, vector<FixedComplex<32> > data); //stitches data based on inputs given. Returns as a vector of fixedcomplex
